...
const int motorPin1A = 46;              //12V DC motor Looping Louie
...
int motorSpeed;
int turboSpeed;
int motorSpeedMinPWM = 30;
int motorSpeedMaxPWM = 100;
int backSpeedPWM = 45;
int fanSpeedPWM = 110;
int speedSteps = 7;
int speedFactor;
...
void setup() {
  TCCR1B &= 0;
  TCCR1B |= 4;          //PWM frequency default 3 = 500 Hz -> 2 = 4kHz
  Serial.begin(9600);
  //Serial1.begin(9600);
  ...
  motorSpeed = 3; //value 0 - 6          all values should be set via iPhone and stored if in case iPhone is disconnected
  turboSpeed = 4; //value 0 - 6
